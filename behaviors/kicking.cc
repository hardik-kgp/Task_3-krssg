...
/*
 * Basic method to kick (or dribble) the         // Move to circle position around center and face the center
ball toward a target position
 */
SkillType NaoBehavior::kickBall(const int kickTypeToUse, const VecPosition &target) {
    kickTarget = target;        // Move to circle position around center and face the center
